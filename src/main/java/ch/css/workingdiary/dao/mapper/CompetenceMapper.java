 ...
 */
public class CompetenceMapper implements ResultSetMapper<Competence> {

    @Override
    public Competence map(int index, ResultSet r, StatementContext ctx) throws SQLException {
        return new Competence(r.getLong("id"), r.getString("description"), r.getInt("number"));
