 ...
 */
public class RatingMapper implements ResultSetMapper<RatingMapper> {

    @Override
    public RatingMapper map(int index, ResultSet r, StatementContext ctx) throws SQLException {
        return null;
    }
}
