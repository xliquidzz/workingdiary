...
public class Rating {
    ...
    private final long learnObjectId;
    private final int rating;

    public Rating(final long id, final long semesterId, final long learnObjectId, final int rating) {
        this.id = id;
        this.semesterId = semesterId;
        this.learnObjectId = learnObjectId;
        this.rating = rating;
    }
}
