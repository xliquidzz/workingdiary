...
(function(){
    angular.module('userModule').config(['$routeProvider', function($routeProvider) {
        $routeProvider.when('/vocation-trainer/user-admin', {
            templateUrl: 'modules/user/views/user-admin.view.html',
        ...
        .when('/user-settings/change-password', {
            templateUrl: 'modules/user/views/change-password.view.html',
