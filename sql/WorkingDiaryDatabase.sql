...
--
-- Dumping data for table `entry_learn_object`
--

LOCK TABLES `entry_learn_object` WRITE;
/*!40000 ALTER TABLE `entry_learn_object` DISABLE KEYS */;
/*!40000 ALTER TABLE `entry_learn_object` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `learn_object`
--

DROP TABLE IF EXISTS `learn_object`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `learn_object`
--

LOCK TABLES `learn_object` WRITE;
/*!40000 ALTER TABLE `learn_object` DISABLE KEYS */;
/*!40000 ALTER TABLE `learn_object` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `learn_object_semester`
--

DROP TABLE IF EXISTS `learn_object_semester`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `learn_object_semester` (
  ...
  KEY `fk_learnObjectId` (`learnObjectId`),
...
--
-- Dumping data for table `learn_object_semester`
--

LOCK TABLES `learn_object_semester` WRITE;
/*!40000 ALTER TABLE `learn_object_semester` DISABLE KEYS */;
/*!40000 ALTER TABLE `learn_object_semester` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `rating` (
  ...
  `learnObjectId` bigint(20) DEFAULT NULL,
  `rating` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `semester_Id` (`semesterId`),
  KEY `learnObject_Id` (`learnObjectId`),
...
-- Dump completed on 2015-06-15 13:33:28
